...
public class WebSockerConnectorSampler extends AbstractSampler implements Interruptible {
    private static final Logger log = LoggerFactory.getLogger(WebSockerConnectorSampler.class);
    ...
    public WebSockerConnectorSampler() {
